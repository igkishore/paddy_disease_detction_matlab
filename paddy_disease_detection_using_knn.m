...
knn_model= fitcknn(training_data,training_class_name,'NumNeighbors',7,'NSMethod','exhaustive','Distance','minkowski','Standardize',1);

[predicted_class_name,score]=predict(knn_model,validating_data);
